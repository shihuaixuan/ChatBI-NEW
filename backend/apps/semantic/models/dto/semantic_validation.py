...
class SemanticValidationReasonCode(StrEnum):
    ...
    METRIC_TIME_GRAIN_UNSUPPORTED = "METRIC_TIME_GRAIN_UNSUPPORTED"
    METRIC_TIME_ALIGNMENT_CONFLICT = "METRIC_TIME_ALIGNMENT_CONFLICT"
    ...
    METRIC_RATIO_UNSAFE = "METRIC_RATIO_UNSAFE"
    TIME_OFFSET_INVALID = "TIME_OFFSET_INVALID"
    PRE_AGGREGATION_GRAIN_INVALID = "PRE_AGGREGATION_GRAIN_INVALID"
