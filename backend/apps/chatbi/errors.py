...
class ResearchRequirementError(ChatBIError, ValueError):
    ...
    SEMANTIC_EXECUTION_ASSET_NOT_COVERED = "SEMANTIC_EXECUTION_ASSET_NOT_COVERED"
...
class ResearchToolExecutionError(ChatBIError, RuntimeError):
    ...
    UNSUPPORTED_CAPABILITY = "RESEARCH_TOOL_UNSUPPORTED_CAPABILITY"
    RECONCILIATION_FAILED = "RESEARCH_TOOL_RECONCILIATION_FAILED"
