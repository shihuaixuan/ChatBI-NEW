"""ChatBI 结果 Artifact 的公开存储与清理实现。

继承自已退役的 Graph Workflow Engine，现由 Agent 执行链路与会话联合删除消费。
"""
...
from apps.chatbi.adapters.artifact_store.domain import ArtifactRef
from apps.chatbi.adapters.artifact_store.file_store import (
    FileArtifactStore,
