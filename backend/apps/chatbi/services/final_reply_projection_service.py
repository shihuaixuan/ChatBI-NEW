...
class FinalReplyProjectionError(ValueError):
    """最终回复投影不满足业务前置条件。"""
...
class FinalReplyProjectionService:
    """生成前端消费的稳定最终回复。"""

    @staticmethod
    def project(data: FinalReplyProjectionData) -> FinalReplyProjectionResult:
...
__all__ = ["FinalReplyProjectionError", "FinalReplyProjectionService"]
