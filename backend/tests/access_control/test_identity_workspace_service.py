...
from apps.access_control.models.dto import UserCreator, UserRecord, WorkspaceRecord
...
def _workspace(workspace_id: int) -> WorkspaceRecord:
    return WorkspaceRecord(id=workspace_id, name=f"workspace-{workspace_id}", create_time=1)
